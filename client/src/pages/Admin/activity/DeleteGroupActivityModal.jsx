...
import { deleteGroupActivity } from '../../../redux/activityRelated/activityHandle';

const DeleteGroupActivityModal = ({ onClose, activity }) => {

    const dispatch = useDispatch();

    const handleDelete = () => {
        dispatch(deleteGroupActivity(activity._id))
        onClose();
    }
    return (
...
export default DeleteGroupActivityModal