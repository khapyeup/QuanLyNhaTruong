            ...
            <div className="flex flex-col gap-2 md:gap-4 mt-5">
              ...
              <div className="border p-3 rounded-xl flex flex-col gap-2 md:gap-4 mt-5">
                ...
                <Input
                  ...
                  name="fatherName"
                  defaultValue={parent.parentInfo?.fatherName}
                />
                <Input
                  type="number"
                  label="Tuổi"
                  {...register("fatherAge", { required: true })}
                  name="fatherAge"
                  defaultValue={parent.parentInfo?.fatherAge}
                />
                <Input
                  type="text"
                  label="Email"
                  {...register("fatherEmail", { required: true })}
                  name="fatherEmail"
                  defaultValue={parent.parentInfo?.fatherEmail}
                />
                <Input
                  type="text"
                  label="Điện thoại"
                  ...
                  name="fatherPhone"
                  defaultValue={parent.parentInfo?.fatherPhone}
                />
                <Input
                  type="text"
                  label="CCCD"
                  {...register("fatherPassport", { required: true })}
                  name="fatherPassport"
                  defaultValue={parent.parentInfo?.fatherPassport}
                />
              </div>
              ...
              <div className="border p-3 rounded-xl flex flex-col gap-2 md:gap-4 mt-5">
                ...
                <Input
                  ...
                  name="motherName"
                  defaultValue={parent.parentInfo?.motherName}
                />
                <Input
                  type="number"
                  label="Tuổi"
                  {...register("motherAge", { required: true })}
                  name="motherAge"
                  defaultValue={parent.parentInfo?.motherAge}
                />
                <Input
                  type="text"
                  label="Email"
                  ...
                  name="motherEmail"
                  defaultValue={parent.parentInfo?.motherEmail}
                />
                <Input
                  type="text"
                  label="Điện thoại"
                  ...
                  name="motherPhone"
                  defaultValue={parent.parentInfo?.motherPhone}
                />
                <Input
                  type="text"
                  label="CCCD"
                  {...register("motherPassport", { required: true })}
                  name="motherPassport"
                  defaultValue={parent.parentInfo?.motherPassport}
                />
              </div>
              {/* <label htmlFor="profile">Avatar</label>
              <img src={parent?.profile} alt="Ảnh đại diện"/>
              <input
                type="file"
                id="profile"
                name="profile"
