      ...
      {isLoading ? <Loading /> : <div>
        <Tabs value="info">
          ...
          <TabsBody>
            ...
            <TabPanel key="progress" value="progress" className="flex flex-col gap-4">
            <Link to={`/students/${id}/record/add`} className="border border-red-600 hover:bg-red-600 hover:text-white p-2 text-center rounded-md">Thêm bản ghi mới</Link>
              <ProgressRecords />
            </TabPanel>
